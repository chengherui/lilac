...
class Verify extends CI_Controller {
    ...
    public function updateOrder() {
        ...
        $this->load->database('default');
        $sql = "update orders set status='" . $_POST['newstatus'] . "' where id=" . $_POST['orderid'];
        $query = $this->db->query($sql);

        $verifyid = $this->session->userdata('id');
        $sql = "insert into news (`oid`,`verifyid`,`verifycomment`,`create_time`,`newstatus`) values ('" . $_POST['orderid'] . "','" . $verifyid . "','" . $_POST['verifycomment'] . "',null,'" . $_POST['newstatus'] . "')";
        $query = $this->db->query($sql);

        redirect('/admin/orders?id=' . $_POST['orderid']);
    }
}
